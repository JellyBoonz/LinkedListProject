...
public class ListModel extends AbstractTableModel {
     ...
     */
    private MyDoubleWithOutTailLinkedList listOfRentals; //Was ArrayList<Rental>

    /**
     * holds only the rentals that are to be displayed
     */
    private MyDoubleWithOutTailLinkedList fileredListRentals; //Was ArrayList<Rental>
    ...
    public void loadDatabase(String filename) {
        ...
        try {
            ...
            listOfRentals = (MyDoubleWithOutTailLinkedList) is.readObject(); //Was ArrayList<Rental>
            UpdateScreen();
            is.close();
        } catch (Exception ex) {
